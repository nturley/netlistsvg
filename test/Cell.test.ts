...
test('Create Cell from Yosys Input Port', () => {
    ...
    const cell: Cell = Cell.fromPort(inputPort, 'testInput', null);
...
test('Create Cell from Yosys Output Port', () => {
    ...
    const cell: Cell = Cell.fromPort(inputPort, 'testOutput', null);
...
test('Create Cell from Constant', () => {
    const cell: Cell = Cell.fromConstantInfo('bob', [0, 1, 0, 1, 1], null);
...
test('Create Cell from Join', () => {
    const cell: Cell = Cell.fromJoinInfo(',3,4,5,', ['0', '1:2'], null);
